...
# Kept identical to the copy in rip-disc.ps1.
...
# an extra on hosts that support it. Kept identical to the copy in rip-disc.ps1.
...
$script:LogFile = Join-Path $logDir "${safeTitle}_${logDiscLabel}_continue_${logTimestamp}.log"
